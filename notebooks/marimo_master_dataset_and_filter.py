...
def _():
    ...
    return Path, SeqIO, gdown, gzip, mo, np, os, pd, requests, shutil
...
@app.cell
def _(Path, SeqIO, gdown, gzip, np, os, pd, requests, shutil):
    class DataSource:
    ...
    return create_master_dataset, filter_dataset


@app.cell
def _(Path, create_master_dataset, filter_dataset):
    data_dir = Path("./data")
    force_download = True
    cell_list = ["K562_ENCLB843GMH", "hESCT0_ENCLB449ZZZ", "HepG2_ENCLB029COU", "GM12878_ENCLB441ZZZ"]
    def main():
