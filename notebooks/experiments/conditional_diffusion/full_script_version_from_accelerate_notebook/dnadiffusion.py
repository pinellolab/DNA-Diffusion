        ...
        for epoch in tqdm(range(self.start_epoch, self.epochs)):
            ...
            for step, batch in enumerate(self.train_dl):
                ...
                with self.accelerator.autocast():
                    loss = p_losses(self.model, x, t, y, loss_type="huber" , sqrt_alphas_cumprod_in= sqrt_alphas_cumprod, sqrt_one_minus_alphas_cumprod_in = sqrt_one_minus_alphas_cumprod, device=self.device)
