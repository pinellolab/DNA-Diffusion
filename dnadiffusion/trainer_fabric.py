...
class Trainer:
    def __init__(
        ...
        """
        self.fabric = Fabric(accelerator="cuda", devices=8, num_nodes=1, strategy="ddp")
        self.fabric.launch() 
        ...
        self.train_dl = self.fabric.setup_dataloaders(train_dl)
    ...
    def train(self):
        ...
        for epoch in tqdm(range(self.start_epoch, self.epochs)):
            ...
            if epoch != 0 and epoch % 500 == 0 and self.fabric.global_rank == 0:
                model_path = (
