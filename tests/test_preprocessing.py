...
def test_filtering_data():
    ...
    FilteringData(data_path, df_path, cell_list).filter_exclusive_replicates(sort=True, balance=True)

    # Assert file path exists
    assert os.path.exists(data_path + "/K562_hESCT0_HepG2_GM12878_12k_sequences_per_group.txt")

    # Loading the output
    df = pd.read_csv(data_path + "/K562_hESCT0_HepG2_GM12878_12k_sequences_per_group.txt", sep="\t")
    ...
    # Remove output file
    os.remove(data_path + "/K562_hESCT0_HepG2_GM12878_12k_sequences_per_group.txt")
